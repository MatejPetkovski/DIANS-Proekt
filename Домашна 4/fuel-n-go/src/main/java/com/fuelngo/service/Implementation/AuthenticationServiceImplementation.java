...
public class AuthenticationServiceImplementation implements AuthenticationService {
    ...
    @Override
    public User register(String email_address, String username, String password, String repeatPassword, Role role) {
        ...
        user=new User(email_address,username,password,role);
